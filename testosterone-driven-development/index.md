...
Короткая заметка про мозги. Ведь я сторонник мнения, что наши мозги содержат в себе легаси-архитектуру. Как говориться, исторически так сложилось.
-->
...
если мы всегда следуем интуитивным выводам без размышлений над результатами, то проекты превращаются в тыкву, а программирование в рутину. Это лежит в основе доклада"
"-->

<img src="./images/brain-architechture.png" />
  
<!-- slide class="light-side" data-notes="
Возможно вы уже задались вопросом почему в анонсе был объявлен некий Владимир, а перед вами стоит какой-то Мартын. Так и спланировано: докладчика будет два. С Вовой мы знакомы с самого детства поэтому хорошо сработались. И хоть мы и похожи внешне, по убеждением мы сильно отличаемся.
...
Вова — человек, который пишет код не по книгам и курсам, а как научила жизнь. То есть он практик. Ещё он плохо шутит.
...
<!-- slide data-notes="
статистическая типизация это десять шагов назад — ведь у нас уже есть JS, который умеет определять типы динамически
"-->
...
— перестаньте чувствовать запахи
"  -->
...
🃏 Что делает плохой некромант когда комментирует ненужный код — верит в то, что мёртвое можно воскресить
" -->
...
<!-- slide data-notes="
есть только один правильный стиль — адекватный и машина этого не поймёт
</br>
