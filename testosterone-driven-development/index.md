...
<!-- slide class="title-slide" data-notes="Полагаю вы уже знаете как называется этот доклад" -->
...
Как бы странно эта цитата не звучала, но мне кажется, она хорошо отражает суть доклада
" -->
...
<!-- slide class="centered" data-notes="Кодэ — ..."-->
...
Без дисклеймера тут не обойтись потому что этот доклад содержит перечисление худших практик программирования.

</br></br>
Если вы увидели в докладе усмешку над кем-то, то только над самим собой в прошлом, настоящем и, к сожалению, в будущем.
" -->
### [Дисклеймер!]()
...
Короткая заметка про мозги. Я сторонник мнения, что наши мозги содержат в себе легаси-архитектуру. Как говориться, исторически так сложилось.

</br></br>
Эта архитектура похожа на слоистую, но с той разницой, что полезная «бизнес-логика» сосредоточилась на внешнем слое в перемешку представлением, а в ядре у нас много методов устаревших, которые были необходимы десятки тысяч лет назад для выживания.

</br></br>
Прямо как в жизни, когда хотели как лучше, а получилось как всегда.
-->
### Про мозг и заблуждения

<!-- slide class="light-side" vertical="true" data-notes="
На этом изображении вы можете усмoтреть схожие черты

</br>
Совпадение? Не думаю. Просто эволюция любит тестировать на продакшене.

</br></br>
Мы придумываем элегантные абстракции и пишем красивый код, но иногда, в моменты усталости, перегруженности или болезни у нас проскакивают «животные» мысли: отрицание нового, агрессия к чужакам, боязнь за своё место, поспешность решений и так далее.
...
<!-- slide class="light-side" data-notes="
Возможно вы уже задались вопросом почему в анонсе был объявлен некий Владимир, а перед вами стоит какой-то Мартын. Так и спланировано: докладчика будет два. С Вовой мы знакомы с самого детства поэтому хорошо сработались. И хоть мы и похожи внешне, внутренне мы сильно отличаемся.

</br></br>
Но как тогда вам различать где чья мысль — спросите вы. А у меня есть для вас везкий довод: я инвертировал слайды Вовы. В его слайдах вам понадобиться думать наоборот, хотя для этого достаточно отбрасывать частицу НЕ.
...
Я знаю его как умелого и быстрого исполнителя, который несколько выгорел и стал циничным. Многие его текущие убеждения это результат искажений и логических ошибок.

</br></br>
Он Вова расскажет основную часть этого доклада, а я помог со слайдами и буду отвечать на ваши вопросы в конце.
...
Доклад давно засел в моей голове и уже наболел, хочется высказаться поскорее."-->
...
<!-- slide data-notes="
Не пускайте женщин в программирование. Мы на данный момент хорошо справляемся и среди нас очень мало женщин, но раньше их было ещё меньше.
...
<!-- slide data-notes="
Представляю как коллега предлагает мне на ревью опробовать его синтаксический сахарок — жуть
" -->
...
<!-- slide data-notes="
У меня есть свой Закон Мёрфи:
Если тест будет написан, то он обязательно упадёт и помешает мне писать код
"-->
### [НЕ]() пишите тесты
...
<!-- slide data-notes="
Код с типам подобен супермаркету, где продукты открыто лежат, но на каждом из них налеплена бирка с составом и ценой. Но я хочу изучать и платить, а хочу просто взять свой хлеб и использовать его по назначению. 
"-->
...
Ведь рефакторинг — как как детская игра в горячую картошку — если уж потрогал код, то теперь тебе нужно поскорее передать ответственность кому-то ещё
"  -->
...
<!-- slide data-notes="
За мою склонность комментировать ненужный код мои коллеги прозвали меня некромантом — ведь я верю, что мёртвое можно воскресить
" -->
...
<!-- slide class="light-side" data-notes="
Вот горячо мною любимые книги, которые я взял за основу доклада, хотя конечно подобных книг больше, но порекомендую только три. У каждой есть перевод на русский.
" -->
### ⚫️ Материалы
